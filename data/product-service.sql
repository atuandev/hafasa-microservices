...
-- Dumping data for table hafasa_product_db.books: ~6 rows (approximately)
DELETE FROM `books`;
...
-- Dumping data for table hafasa_product_db.book_images: ~14 rows (approximately)
...
-- Dumping data for table hafasa_product_db.reviews: ~0 rows (approximately)
DELETE FROM `reviews`;
